    ...
    private void showWarningWhenNoPassword() {
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                // set title
                alertDialogBuilder.setTitle(getString(R.string.no_password_selected));

                // set dialog message
                alertDialogBuilder
                        .setMessage(getString(R.string.protection_enabled_without_pwd_select_pwd_request))
                        .setCancelable(true)
