...
import com.st.st25nfc.type5.SectorListFragment;

public class STM24LRSectorActivity extends STFragmentActivity
        implements NavigationView.OnNavigationItemSelectedListener, STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    SectorListFragment mFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragment = new SectorListFragment();
