...
import com.st.st25nfc.type5.SectorLockFragment;
import com.st.st25nfc.generic.ST25Menu;


public class STM24LRSectorLockActivity extends STFragmentActivity
        implements NavigationView.OnNavigationItemSelectedListener, STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "STM24LRSectorLockActivity";
    SectorLockFragment mFragment;
    private int mSector;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragment = new SectorLockFragment();

        Bundle bundle = getIntent().getExtras();
        if (bundle != null) {
            mFragment.setArguments(bundle);
            mSector = bundle.getInt("sector_nbr");
        }
