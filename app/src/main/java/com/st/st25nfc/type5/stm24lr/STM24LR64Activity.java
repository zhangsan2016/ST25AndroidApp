...
public class STM24LR64Activity extends STFragmentActivity implements NavigationView.OnNavigationItemSelectedListener,
        STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "STM24LR64Activity";
    public M24LR64KTag mM24LR64Tag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mM24LR64Tag = (M24LR64KTag) super.getTag();
        if (mM24LR64Tag == null) {
        ...
        getSupportActionBar().setTitle(mM24LR64Tag.getName());
