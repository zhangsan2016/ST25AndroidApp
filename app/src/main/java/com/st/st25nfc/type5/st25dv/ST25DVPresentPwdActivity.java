        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                if (area3PwdRadioButton.isChecked()) {
                    try {
                        passwordNumber = myTag.getPasswordNumber(MultiAreaInterface.AREA3);
                    } catch (STException e) {
                        e.printStackTrace();
                    }
