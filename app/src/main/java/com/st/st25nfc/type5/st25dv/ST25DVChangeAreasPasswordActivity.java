...
public class ST25DVChangeAreasPasswordActivity extends STFragmentActivity implements STType5PwdDialogFragment.STType5PwdDialogListener, NavigationView.OnNavigationItemSelectedListener {
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    final int area1PasswordNumber = myTag.getPasswordNumber(AREA1);
                    final int area2PasswordNumber = myTag.getPasswordNumber(MultiAreaInterface.AREA2);
                    final int area3PasswordNumber = myTag.getPasswordNumber(MultiAreaInterface.AREA3);
                    final int area4PasswordNumber = myTag.getPasswordNumber(MultiAreaInterface.AREA4);
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            int passwordNumber = ST25DVTag.ST25DV_PASSWORD_1;
                            for (int area = AREA1; area <= myTag.getMaxNumberOfAreas(); area++) {
                                switch(area) {
                                    case 1:
                                        ...
                                        mArea1RadioButton.setText(getResources().getString(R.string.area1) + " " + (area1PasswordNumber == 0? getString(R.string.no_password_currently_set):getString(R.string.currently_protected_by_password,area1PasswordNumber)));
                                    ...
                                    case 2:
                                        ...
                                        mArea2RadioButton.setText(getResources().getString(R.string.area2) + " " + (area2PasswordNumber == 0? getString(R.string.no_password_currently_set):getString(R.string.currently_protected_by_password,area2PasswordNumber)));
                                    ...
                                    case 3:
                                        ...
                                        mArea3RadioButton.setText(getResources().getString(R.string.area3) + " " + (area3PasswordNumber == 0? getString(R.string.no_password_currently_set):getString(R.string.currently_protected_by_password,area3PasswordNumber)));
                                    ...
                                    case 4:
                                        ...
                                        mArea4RadioButton.setText(getResources().getString(R.string.area4) + " " + (area4PasswordNumber == 0? getString(R.string.no_password_currently_set):getString(R.string.currently_protected_by_password,area4PasswordNumber)));
                            ...
                            if (mArea1RadioButton.isChecked()) enablePasswordRadioButton(area1PasswordNumber);
                            if (mArea2RadioButton.isChecked()) enablePasswordRadioButton(area2PasswordNumber);
                            if (mArea3RadioButton.isChecked()) enablePasswordRadioButton(area3PasswordNumber);
                            if (mArea4RadioButton.isChecked()) enablePasswordRadioButton(area4PasswordNumber);
    ...
    private void enablePasswordRadioButton(int passwordNumber) {
    ...
    private ST25DVRegisterRfAiSS.ST25DVSecurityStatusPWDControl getPasswordControlStatus(int passwordNumber) {
    ...
    private void changeAreaPassword() {
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    // AREA1 : 分区号，areaPassword ： 指定的分区密码
