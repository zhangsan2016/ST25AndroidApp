...
public class ST25TVChangePwdActivity extends STFragmentActivity implements STType5PwdDialogFragment.STType5PwdDialogListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View childView = getLayoutInflater().inflate(R.layout.fragment_st25tv_change_password, null);
    ...
    private void enterOldPassword() {
        new Thread(new Runnable() {
            public void run() {
                int passwordNumber = ST25TVTag.ST25TV_AREA1_PASSWORD_ID;
                String message = "";
    ...
    private void enterNewPassword() {
        new Thread(new Runnable() {
            public void run() {
                ...
                if (area1PwdRadioButton.isChecked()) {
                    passwordNumber = ST25TVTag.ST25TV_AREA1_PASSWORD_ID;
                    message = getResources().getString(R.string.enter_new_area1_pwd);
                }

                RadioButton area2PwdRadioButton = (RadioButton) findViewById(R.id.area2PwdRadioButton);
                if (area2PwdRadioButton.isChecked()) {
                    passwordNumber = ST25TVTag.ST25TV_AREA2_PASSWORD_ID;
                    message = getResources().getString(R.string.enter_new_area2_pwd);
                }
