...
public class ST25TVAreaSecurityStatusActivity extends STFragmentActivity
        implements NavigationView.OnNavigationItemSelectedListener, STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "ReadWriteProtection";
    ST25TVAreaSecurityStatusFragment mFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragment = new ST25TVAreaSecurityStatusFragment();
