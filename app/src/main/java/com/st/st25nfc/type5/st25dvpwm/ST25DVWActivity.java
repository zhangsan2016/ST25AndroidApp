...
public class ST25DVWActivity extends STFragmentActivity
        implements NavigationView.OnNavigationItemSelectedListener, STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "ST25DVWActivity";
    public ST25DVPwmTag mST25DVPwmTag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mST25DVPwmTag = (ST25DVPwmTag) super.getTag();
        if (mST25DVPwmTag == null) {
        ...
        getSupportActionBar().setTitle(mST25DVPwmTag.getName());
    ...
    public ST25DVPwmTag getTag() {
        return mST25DVPwmTag;
    }
