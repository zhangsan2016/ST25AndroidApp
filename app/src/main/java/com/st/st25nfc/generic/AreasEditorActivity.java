...
public class AreasEditorActivity extends STFragmentActivity
        implements NavigationView.OnNavigationItemSelectedListener, STFragment.STFragmentListener {

    // Set here the Toolbar to use for this activity
    private int toolbar_res = R.menu.toolbar_empty;

    final static String TAG = "AreasEditorActivity";
    AreasEditorFragment mFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragment = new AreasEditorFragment();
